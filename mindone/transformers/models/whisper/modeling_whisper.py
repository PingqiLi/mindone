...
class WhisperPreTrainedModel(MSPreTrainedModel):
    """
    This class represents a pre-trained model for the Whisper framework. It inherits from the MSPreTrainedModel class,
